...
export default function Settings() {
    ...
    const selectBlitz = () => {
        setBlitzSelect(true);
        setNormalSelect(false);
        setInfinitySelect(false);
        setTime(300);
    }

    const selectNormal = () => {
        setBlitzSelect(false);
                ...
                <View style={{ flex: 0, justifyContent: "center", gap: 30 }}>
                    <View style={{ flex: 0, justifyContent: "center", gap: 10 }}>
                        ...
                        <View style={{ flex: 0, flexDirection: "row", alignItems: "center", justifyContent: "space-evenly", paddingVertical: 20, backgroundColor: "#181717ff", borderRadius: 10, borderWidth: 3, borderColor: "#2423237a" }}>
                            <TouchableOpacity onPress={selectBlitz} style={[styles.selectedMode, blitzSelect ? styles.selectedMode : styles.mode]}>
                                <Text style={{ textAlign: "center", color: "#ffffffc5" }}>Blitz</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={selectNormal} style={[styles.mode, normalSelect ? styles.selectedMode : styles.mode]}>
                                <Text style={{ textAlign: "center", color: "#ffffffc5" }}>Normal</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={selectInfinity} style={[styles.mode, infinitySelect ? styles.selectedMode : styles.mode]} >
